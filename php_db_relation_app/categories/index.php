...
include_once '../utils.php';
 $catégories=recuperer_tous("categorie");
 ?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
extract($_GET);
     ...
     <?php endif ?>
     <?php if (isset($del)): ?>
       <div class="alert alert-danger">catégorie Supprimée avec succès</div>
     <?php endif ?>
     <?php if (isset($upd)): ?>
       <div class="alert alert-warning">catégorie modifiée avec succès</div>
     <?php endif ?>
    <div class="container">
      ...
      <table class="tab table table-striped">
            ...
            <tbody>
              ...
              <?php foreach ($catégories as $c => $ligne): ?>
                 <tr>
